...
public class FibonacciDemo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (n > 0) {
            ...
            System.out.println("Number of calls to method rfib when n == 2:");

            System.out.println("\nStarting recursive Fibonacci ..."+methodCalls2);
            ...
            elapsed = (System.currentTimeMillis() - startTime);
            System.out.println("Elapsed time: " + elapsed + "ms; number of calls to the algorithm: " + methodCalls);
            System.out.println("Number of calls to method rfib when n == 2:"+methodCalls2);
